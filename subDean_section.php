...
$insertSql = "INSERT INTO sub_dean_pending_students (id, stud_name, matric_num, arrived_at) 
                ...
                WHERE college_dean_comment IS NOT NULL 
                AND (stud_name, matric_num) NOT IN 
                (SELECT stud_name, matric_num FROM sub_dean_pending_students)
                AND (stud_name, matric_num) NOT IN 
                (SELECT stud_name, matric_num FROM sub_dean_attended_students)
              ";
