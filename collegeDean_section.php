...
// Fetch removed students from the college dean attended students table
$removedStudents = [];
...
<body class="preview-page">
  ...
  <script>
        ...
        // Fetch college dean pending students if it exists
        $.ajax({
        ...
        function renderStudents() {
            ...
            if (removedStudent) {
                ...
                success: function() {
                    // Removing the student from the college dean pending students list after endorsement/rejection
                    $.ajax({
                    ...
                    error: function() {
                        alert("Error removing student from college_dean_pending_students");
                    }
                    });
                },
                error: function() {
            ...
            actionLink.href = `./collegeDeanEndorse.php?matric_num=${student.matric_num}`;
